import { getAllBooks, getBooksById, createBook } from '~/repositories/book.repository';
import { getAllBooksRoute, getBooksByIdRoute, createBookRoute } from '~/routes/book.route';
